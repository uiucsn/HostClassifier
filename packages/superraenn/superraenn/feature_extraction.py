...
def main():
    ...
    parser.add_argument('--model_type', type=str, dest='submodel', default='', help='...')
    ...
    if args.outdir[-1] != '/':
        args.outdir += '/'
    save_features(features, ids, feat_names, args.outfile+'_'+submodel+'_'+date, outdir=args.outdir)
